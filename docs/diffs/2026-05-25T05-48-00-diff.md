...
index 0000000..0320aae
--- /dev/null
+++ b/.phpunit.cache/test-results
@@ -0,0 +1 @@
+{"version":2,"defects":[],"times":{"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_create_returns_model_and_persists_to_database":0.031,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_find_returns_model_when_exists":0.004,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_find_returns_null_when_not_exists":0.003,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_find_by_returns_collection_with_filters_and_limit":0.004,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_find_by_returns_all_without_limit_when_limit_is_null":0.004,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_update_updates_only_non_null_fields_and_returns_updated_model":0.004,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_update_throws_exception_when_user_not_found":0.003,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_delete_returns_true_when_user_exists":0.005,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_delete_returns_false_when_user_not_exists":0.003,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_count_returns_total_without_criteria":0.003,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_count_returns_total_with_criteria":0.004,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_exists_returns_true_when_criteria_matches":0.004,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_exists_returns_false_when_criteria_not_matches":0.003,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_paginate_returns_paginated_results_with_filters_and_sorting":0.006,"AndyDefer\\Repository\\Tests\\Integration\\AbstractRepositoryTest::test_delete_bulk_deletes_multiple_models_matching_criteria":0.004}}
\ No newline at end of file
diff --git a/Makefile b/Makefile
new file mode 100644
index 0000000..66cdba9
--- /dev/null
+++ b/Makefile
@@ -0,0 +1,497 @@
+# ===================================================
...
+	@read -p "📁 Enter the source directory path to scan (leave empty for current directory '.'): " SOURCE_PATH; \
+	if [ -z "$$SOURCE_PATH" ]; then \
+		SOURCE_DIRS="."; \
+		echo "🔗 Concatenating all .md files from current directory into all.md..."; \
+	else \
+		SOURCE_DIRS="$$SOURCE_PATH"; \
+		echo "🔗 Concatenating all .md files from directory: $${SOURCE_DIRS} into all.md..."; \
+	fi; \
...
+
+concat-all: ## Concatène tous les fichiers PHP, TS, TSX
+	@read -p "📁 Répertoire (vide = ./app ./database ./routes) : " SOURCE_PATH; \
+	if [ -z "$$SOURCE_PATH" ]; then \
+		SOURCE_DIRS="./app ./database ./routes"; \
+	else \
+		SOURCE_DIRS="$$SOURCE_PATH"; \
+	fi; \
+	find $$SOURCE_DIRS -type f \( -name "*.php" -o -name "*.ts" -o -name "*.tsx" \) -exec sh -c 'echo ""; echo "// ==== {} ==="; echo ""; cat {}' \; > all.txt; \
+	echo "✅ all.txt généré"
+
+
+# ---------------------------------------------------
...
+
+.PHONY: diagram 
+diagram: ## Convertir un DOT en PNG pour voir en ligne sur https://dreampuf.github.io/GraphvizOnline/
+	@echo "📐 Conversion du diagramme DOT en PNG"
+	@echo ""
+	@read -p "📁 Chemin vers le fichier .dot (relatif ou absolu): " DOT_PATH; \
+	if [ ! -f "$$DOT_PATH" ]; then \
+		echo "❌ Fichier introuvable: $$DOT_PATH"; \
+		exit 1; \
+	fi; \
+	mkdir -p diagrams; \
+	OUTPUT_NAME=$$(basename "$$DOT_PATH" .dot); \
+	echo "📝 Génération de diagrams/$$OUTPUT_NAME.png..."; \
+	dot -Tpng -Gdpi=300 "$$DOT_PATH" -o "diagrams/$$OUTPUT_NAME.png"; \
+	echo "✅ Diagramme généré: diagrams/$$OUTPUT_NAME.png"
+
+# ---------------------------------------------------
+# Help & Documentation
+# ---------------------------------------------------
...
+    "autoload-dev": {
+        "psr-4": {
+            "AndyDefer\\Repository\\Tests\\": "tests/"
+        }
+    },
+    "extra": {
+        "laravel": {
...
+    ],
+    "content-hash": "de58471a5e9f0a4b8e4f34a25a97fdba",
+    "packages": [
+        {
...
+</phpunit>
\ No newline at end of file
diff --git a/src/AbstractRepository.php b/src/AbstractRepository.php
new file mode 100644
index 0000000..779c217
--- /dev/null
...
+
+    /**
+     * @param Recordable|null $criteria
+     * @return int
+     */
...
+    }
+}
diff --git a/src/AbstractRepositoryInterface.php b/src/AbstractRepositoryInterface.php
new file mode 100644
index 0000000..0dea6cb
--- /dev/null
+++ b/src/AbstractRepositoryInterface.php
@@ -0,0 +1,81 @@
+<?php
+
+declare(strict_types=1);
...
+    public function deleteBulk(Recordable $criteria): int;
+}
diff --git a/src/Exceptions/ModelNotFoundException.php b/src/Exceptions/ModelNotFoundException.php
new file mode 100644
index 0000000..5514636
--- /dev/null
...
+    }
+}
diff --git a/src/Records/FindByRecord.php b/src/Records/FindByRecord.php
new file mode 100644
index 0000000..3bd6b4f
--- /dev/null
+++ b/src/Records/FindByRecord.php
@@ -0,0 +1,20 @@
+<?php
+
+declare(strict_types=1);
...
+    ) {}
+}
diff --git a/src/Records/PaginateRecord.php b/src/Records/PaginateRecord.php
new file mode 100644
index 0000000..5f14452
--- /dev/null
+++ b/src/Records/PaginateRecord.php
@@ -0,0 +1,21 @@
+<?php
+
+declare(strict_types=1);
...
+    ) {}
+}
diff --git a/src/Records/RepositoryInfoRecord.php b/src/Records/RepositoryInfoRecord.php
new file mode 100644
index 0000000..9e11205
--- /dev/null
+++ b/src/Records/RepositoryInfoRecord.php
@@ -0,0 +1,19 @@
+<?php
+
+declare(strict_types=1);
...
+    ) {}
+}
diff --git a/tests/Fixtures/Repositories/TestUserRepository.php b/tests/Fixtures/Repositories/TestUserRepository.php
new file mode 100644
index 0000000..a105c67
--- /dev/null
+++ b/tests/Fixtures/Repositories/TestUserRepository.php
@@ -0,0 +1,50 @@
+<?php
+
+declare(strict_types=1);
...
+    }
+}
diff --git a/tests/Fixtures/migrations/create_test_users_table.php b/tests/Fixtures/migrations/create_test_users_table.php
new file mode 100644
index 0000000..881bd71
--- /dev/null
+++ b/tests/Fixtures/migrations/create_test_users_table.php
@@ -0,0 +1,28 @@
+<?php
+
+declare(strict_types=1);
...
+    }
+};
diff --git a/tests/Integration/AbstractRepositoryTest.php b/tests/Integration/AbstractRepositoryTest.php
new file mode 100644
index 0000000..de46902
--- /dev/null
+++ b/tests/Integration/AbstractRepositoryTest.php
@@ -0,0 +1,337 @@
+<?php
+
+declare(strict_types=1);
